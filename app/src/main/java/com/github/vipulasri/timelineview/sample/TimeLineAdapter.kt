    ...
    override fun onBindViewHolder(holder: TimeLineViewHolder, position: Int) {
        ...
        when {
            timeLineModel.status == OrderStatus.INACTIVE -> {
                holder.timeline.setMarker(VectorDrawableUtils.getDrawable(holder.itemView.context, R.drawable.ic_marker_inactive, mAttributes.markerColor), false)
            }
            timeLineModel.status == OrderStatus.ACTIVE -> {
                holder.timeline.setMarker(VectorDrawableUtils.getDrawable(holder.itemView.context, R.drawable.ic_marker_active, mAttributes.markerColor), false)
            }
            else -> {
