...
class ExampleActivity : BaseActivity() {
    ...
    private fun setDataListItems() {
        ...
        mDataList.add(TimeLineModel("Courier is out to delivery your order", "2017-02-12 08:00", OrderStatus.INACTIVE))
        ...
        mDataList.add(TimeLineModel("Order is being readied for dispatch", "2017-02-11 08:00", OrderStatus.INACTIVE))
        mDataList.add(TimeLineModel("Order processing initiated", "2017-02-10 15:00", OrderStatus.INACTIVE))
